...
Flag Format: Diver25{ship name in the local language\_number}\
(e.g. If the ship name is "ペンギン饅頭号" and the number is 1234567, the flag should be Diver25{ペンギン饅頭号\_1234567}.)

![chall](<../../../.gitbook/assets/chall (2).png>)
...
![imgsearch](../../../.gitbook/assets/search.png)
