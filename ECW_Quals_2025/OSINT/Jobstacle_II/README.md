# ECW Qualifiers CTF 2025 - OSINT : Jobstacle\_II
...
ECW{125.10.35.2\_Victoire\_Lanctot}
...
The flag format is ECW{xxx.xx.xx.x\_Hugo\_Baguette}
...
![mosque](../../../.gitbook/assets/mosque.png)
...
![pharm1](../../../.gitbook/assets/pharm1.png)

Following the 2023 coverage on street view, we come accross this :

![arrows](../../../.gitbook/assets/arrows.png)
...
![google1](../../../.gitbook/assets/google1.png)
...
![mobile35](../../../.gitbook/assets/mobile35.png)

We then get our third number : **`35`**

> \[!NOTE]\
> Apparently this wasn't the intended solve for this paragraph, as the correct reference was "PC35" near another pharmacie, but since the numbers are the same this wasn't an issue for the rest of the challenge.
...
![ID](../../../.gitbook/assets/ID.png)

We then see that the account is named 'PepitoChrysali'

![steam](../../../.gitbook/assets/steam.png)
...
![final](../../../.gitbook/assets/final.png)
