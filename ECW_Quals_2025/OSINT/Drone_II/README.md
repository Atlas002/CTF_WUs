# ECW Qualifiers CTF 2025 - OSINT : DroneGuesser\_II
...
ECW{2207V21960KV\_1702.7\_31802}
...
ECW{MOTORType\_MaxThrust\_MaxThrustRPM}.

_Take the values from the testing data_

Flag format:\
`ECW{************_****.**_*****}`

![chall](<../../../.gitbook/assets/chall (9).png>)

## Write up

We first reverse image search the profile pitcure to find his socials, and we end up on his [youtube channel](https://www.youtube.com/@%E6%B3%A2%E9%A2%A8%E6%B0%B4%E9%96%80) :

![rev](<../../../.gitbook/assets/rev (2).png>)

![channel](<../../../.gitbook/assets/channel (1).png>)
...
![vid1](<../../../.gitbook/assets/vid1 (1).png>)
...
![close](../../../.gitbook/assets/close.png)
...
![specs](../../../.gitbook/assets/specs.png)
