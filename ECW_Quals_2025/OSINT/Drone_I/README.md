# ECW Qualifiers CTF 2025 - OSINT : DroneGuesser\_I
...
Then, based on the form of the drone's fuselage and its camera, we can deduce that the one we can see in the video is a [Mavic 2 pro](https://chrome-extension/efaidnbmnnnibpcajpcglclefindmkaj/https://dl.djicdn.com/downloads/Mavic_2/Mavic+2+Pro+Zoom+User+Manual+V1.4.pdf) , which gives us the rest of the flag :
