...
Flag format: ECW{12,789456° N 9,895623° W}
...
![lettr](../../../.gitbook/assets/lettr.png)
...
![review](../../../.gitbook/assets/review.png)
...
Looking up that new username, we first find an instagram account : [@labath\_d\_hubert](https://www.instagram.com/labath_d_hubert/?hl=en)
...
![bing](../../../.gitbook/assets/bing.png)

Going over to his account, we can see that he's got only one repo, [meet\_me\_using\_the\_matrix](./), in which we can find a python scripts (which displays pretty characters matrix style and nothing else) and a picture :

![git](../../../.gitbook/assets/git.png)

![pic](<../../../.gitbook/assets/pic (1).png>)

We then download the picture and run an `exiftool` on it :

![exif](../../../.gitbook/assets/exif.png)

Bingo, we get GPS coordinates that we just need to convert to the right format :

![coord](../../../.gitbook/assets/coord.png)
